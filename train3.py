...
from model3 import AntibodyDesignModel
from dataset import AntibodyDataset, collate_fn  # 确保导入 collate_fn

def log_print(message, log_file="training_log3.txt"):
...
def main():
    ...
    # 🌟 获取实际的词表大小，传给模型，防止 Embedding 越界
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        if val_loss < best_val_loss - MIN_DELTA:
            ...
            epochs_no_improve = 0
            torch.save(model.state_dict(), "best_antibody_model4.pt")
    ...
    # 加载训练好的最好状态
    model.load_state_dict(torch.load("best_antibody_model4.pt"))
